...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔍 Checking user with provided token...');
    ...
    if (addressesError) {
      ...
      console.log('✅ Addresses fetched:', addressesData?.length || 0, 'addresses');
    }
    ...
    console.log('✅ Complete profile with addresses ready');
