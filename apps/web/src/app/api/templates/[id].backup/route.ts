...
// Required for static export: return empty array since API routes shouldn't be statically generated
// This function must be exported at the top level for Next.js to detect it
export async function generateStaticParams(): Promise<Array<{ id: string }>> {
  // API routes are not statically generated, return empty array
  return [];
}
