...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (error && error.message.includes('provider is not enabled')) {
        ...
        setError('Google OAuth ยังไม่ได้เปิดใช้งาน กรุณาใช้การเข้าสู่ระบบด้วยอีเมลแทน');
      }
    } catch (error) {
  ...
  const handleLinkedInLogin = async () => {
    try {
      ...
      if (error && error.message.includes('provider is not enabled')) {
        setShowOAuthWarning(true);
        setError('LinkedIn OAuth ยังไม่ได้เปิดใช้งาน กรุณาใช้การเข้าสู่ระบบด้วยอีเมลแทน');
      }
    } catch (error) {
      console.error('LinkedIn OAuth error:', error);
      setError('เกิดข้อผิดพลาดในการเข้าสู่ระบบด้วย LinkedIn');
    }
  };
